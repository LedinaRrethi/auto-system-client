...
export default function FineTable({ filters, onFilterChange }: Props) {
       ...
       <div className="max-w-full overflow-x-auto">
        ...
        <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
             ...
             <TableCell className="px-5 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Issued By</TableCell>
          ...
          <TableBody>
            {filteredFines.map((fine) => (
              <TableRow key={fine.idpk_Fine}>
                 ...
                 <TableCell className="px-5 py-4 text-sm text-gray-700 dark:text-white">{fine.policeFullName ?? "-"}</TableCell>
