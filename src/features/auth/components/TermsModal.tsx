...
const TermsModal = ({ isOpen, onClose }: TermsModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6 relative">
        <button
          onClick={onClose}
        ...
        <div className="text-gray-800 dark:text-gray-200">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              ...
              <a href="mailto:support@autosystem.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                support@autosystem.com
              </a>.
            </p>
          </section>
        </div>
