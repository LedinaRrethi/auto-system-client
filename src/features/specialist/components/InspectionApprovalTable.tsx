...
export default function InspectionApprovalTable({ inspections }: Props) {
  return (
        ...
        <Table className="w-full min-w-[1000px]">
         <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
               ...
               <TableCell isHeader className="px-5 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Date</TableCell>
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {(inspections ?? []).map((item) => (
              <TableRow key={item.idpK_InspectionRequest}>
                ...
                <TableCell className="px-5 py-4 text-sm text-gray-700 dark:text-white">{item.inspectionDate}</TableCell>
                <TableCell className="px-5 py-4 text-sm text-gray-700 dark:text-white">{item.inspectionTime}</TableCell>
